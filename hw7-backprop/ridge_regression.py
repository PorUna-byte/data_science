...
class RidgeRegression(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, l2_reg=1, step_size=.005,  max_num_epochs = 5000):
        ...
        self.reg_term = nodes.L2NormPenaltyNode(l2_reg, self.w, "l2reg_term")
        self.erm_term = nodes.SquaredL2DistanceNode(a=self.prediction, b=self.y,
                                               node_name="square loss")
        self.objective = nodes.SumNode(self.reg_term, self.erm_term, "Regularized square loss")
